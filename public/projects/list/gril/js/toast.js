...
var zindex = 10001;　　　　　//这里的z-index可以自己调整，保证在其他元素上不被遮挡
...
　　div.innerHTML = '<input type="button" id="app_txt_toast" style="line-height:24px;padding-left:20px;padding-right:20px;border-radius:8px;height:20px;background:#999;color:#fff;font-weight:bolder;border:none;z-index:'+(zindex+1)+';" value="'+message+'"/>';
　　document.body.appendChild(div);　　//向document添加元素

　　$("#app_txt_toast").animate({height:'24px',opacity:'1'}, 200, function(){});　
